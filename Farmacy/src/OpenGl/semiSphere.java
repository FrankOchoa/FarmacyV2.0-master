...
import com.psm.Model.Valores;
import OpenGl.Primitivas;
import android.graphics.Bitmap;
import android.graphics.BitmapFactory;
import android.opengl.GLUtils;


public class semiSphere extends Primitivas {
	private Valores Datos;
	private FloatBuffer vertBuff, NormBuff, Textbuff;
	private ShortBuffer pBuff;
	private int TextureId[] = new int [1];

	public semiSphere(InputStream Imagen, GL10 gl, int Sk, int Sl,float radio, float ini, float fin)
	{
		Datos = new Valores();
